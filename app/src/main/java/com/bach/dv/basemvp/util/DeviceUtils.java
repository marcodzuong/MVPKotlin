...
public class DeviceUtils {
    ...
    public static String getCountryName() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            locale = Utils.getApp().getResources().getConfiguration().getLocales().get(0).getCountry();
        } else {
            locale = Utils.getApp().getResources().getConfiguration().locale.getCountry();
        }
